...
july30exp = "https://raw.githubusercontent.com/AguaClara/Fluoride-Auto/master/Summer%202019/Data%20and%20Graphs/7-30-19/datalog%207-30-2019.xls"
data_raw = pd.read_csv(july30exp, delimiter="\t")
data = pp.remove_notes(data_raw)
time = pd.to_numeric(data.iloc[:,1])/60
...
plt.title("7-30-19 Effluent Fluoride Concentration and Turbidity")
plt.legend((fluoride_plot, turbidity_plot),("Fluoride Concentration","Turbidity"))
plt.savefig("7-30-19 Effluent Fluoride Concentration and Turbidity")
...
plt.title("7-30-19 Floc Blanket Height and Fluoride Concentration over Time")
plt.legend((fluoride_plot, flocblanket_plot),("Fluoride Concentration (mg/L)","Floc Blanket Height (cm)"))
plt.savefig("7-30-19 Floc Blanket Height and Fluoride Concentration")
...
plt.title("7-30-19 Floc Blanket Height and Turbidity over Time")
plt.legend((fluoride_plot, flocblanket_plot),("Turbidity (NTU)","Floc Blanket Height (cm)"))
plt.savefig("7-30-19 Turbidity and Floc Blanket Height")
