...
july30exp = "https://raw.githubusercontent.com/AguaClara/Fluoride-Auto/master/Summer%202019/Data%20and%20Graphs/7-10-19/datalog%207-10-2019.xls"
data_raw = pd.read_csv(july30exp, delimiter="\t")
data = pp.remove_notes(data_raw)
time = pd.to_numeric(data.iloc[:,8])/60
time_number = pd.to_numeric(time)
fluoride = data.iloc[:,10]
turbidity = data.iloc[:,12]
floc_blanket = data.iloc[:,13]
