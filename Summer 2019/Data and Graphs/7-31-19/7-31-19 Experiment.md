...
july31exp = "https://raw.githubusercontent.com/AguaClara/Fluoride-Auto/master/Summer%202019/Data%20and%20Graphs/7-31-19/datalog%207-31-2019.xls"
data_raw = pd.read_csv(july31exp, delimiter="\t")
data = pp.remove_notes(data_raw)
time = pd.to_numeric(data.iloc[0:1112,1])/60
time_number = pd.to_numeric(time)
fluoride = data.iloc[0:1112,3]
turbidity = data.iloc[0:1112,5]
floc_blanket = data.iloc[0:1112,6]
...
plt.title("7-31-19 Effluent Fluoride Concentration and Turbidity")
plt.legend((fluoride_plot, turbidity_plot),("Fluoride Concentration","Turbidity"))
plt.savefig("7-31-19 Effluent Fluoride Concentration and Turbidity")
...
plt.title("7-31-19 Floc Blanket Height (1st Tube) and Fluoride Concentration over Time")
plt.legend((fluoride_plot, flocblanket_plot),("Fluoride Concentration (mg/L)","Floc Blanket Height (cm)"))
plt.savefig("7-31-19 Floc Blanket Height and Fluoride Concentration")
...
plt.title("7-31-19 Floc Blanket Height and Turbidity over Time")
plt.legend((turbidity_plot, flocblanket_plot),("Turbidity (NTU)","Floc Blanket Height (cm)"))
plt.savefig("7-31-19 Turbidity and Floc Blanket Height")
