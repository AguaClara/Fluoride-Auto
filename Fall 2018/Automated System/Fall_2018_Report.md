...
[EM: The first sentence sounds like you're going to PUT excess amounts of fluoride into the water. Consider rephrasing.]
...
[EM: If switching from using the chemical formula to the common name, make sure it is stated what is what, similar to writing out abbreviations before using them frequently.]
...
[EM: This is a super long sentence. Consider breaking it up for fluidity.]
...
[EM: Make sure to say what CSFBR stands for.]
...
[EM: In reference to the 2nd sentence, a concentration of what?] 
...
[EM: What does "W" stand for? Not all variable conventions are the same across disciplines.]
