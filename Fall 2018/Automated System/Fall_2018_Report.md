...
[You all were only supposed to do the first few sections, so I don't know why you have everything else here or whose report you took all it from, but its evident you never read through it. This draft was fine but I hope the next one will be more of your own work. 

## Abstract
The Fluoride subteam [state which fluoride subteam you are] seeks to develop a sustainable, inexpensive fluoride removal system for implementation in upcoming AguaClara plants located in India. Using the apparatus developed in previous semesters, the team continued running experiments testing how various concentrations of PACl affect fluoride removal. The team analyzed the variability of the Langmuir isotherm generated by the summer 2018 Fluoride team. This analysis factored into the overarching goal of developing a model to predict an optimal coagulant dosage given both influent and target effluent fluoride concentrations.
The team also measured and analyzed the concentration and purity of the waste stream to determine the quantity of flocs in the stream and prevent effluent water from unnecessarily being pumped out in the waste stream. The team identified their work involving the Langmuir adsorption model as novel work that has not yet been published.
...
[I know that this is the literature review from the last 1424545 senesters but I wonderif it even needs to be this long, if you all run out of work you could try to condense it. ] 
...
The summer of 2018 began experiments with the new probe delivered during early May. Coagulant dosing was changed based on the isotherm developed during the spring of 2018, which showed that coagulant dosing at 6.25 mg/L will not create a floc blanket. The coagulant dosing ranged from 10 mg/L to 50 mg/L with the influent fluoride concentration ranging from 3 mg/L to 20 mg/L. The team also identified that influent fluoride concentration did not match the ideal concentration set by our flow rate and stock tank concentration. Therefore, the team began to take a manual reading of the influent fluoride before it reached the flocculator to compare to the effluent fluoride reading. Adding the new data points and the correction to the influent fluoride was key in fixing the isotherm generated by the spring and fall 2018 teams. The fit of the isotherm to data points rose from a correlation coefficient of .62 to .82.
...
## Results [Whose results are these?]
...
## Design Considerations [Isn't this section more related to the work that Fluoride grav is doing?]
