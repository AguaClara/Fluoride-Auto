...
# plot all 3 data point sets with the line of best fit and the Theoretical Curve
plt.xlim(0, 11)
plt.ylim(0,400)
plt.xlabel("Effluent Fluoride Concentration (mg/L)")
plt.ylabel("Uptake (mg Fluoride/g PaCl)")
plt.legend((summer18plot, fall18plot, spring19plot,bestfit_plot,theoreticalplot),("Summer 2018", "Fall 2018", "Spring 2019","Line of Best Fit","Theoretical Langmuir Isotherm"))
plt.savefig("C:/Users/emily/github/Fluoride-Auto/Spring 2019/Langmuir Isotherm Data/isotherm.png")
